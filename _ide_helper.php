...
class JavaScript extends Laracasts\Utilities\JavaScript\Facades\JavaScript{
	 ...
	 * @static 
	 */
	 public static function __construct($viewBinder, $namespace = 'window'){
		 Laracasts\Utilities\JavaScript\PHPToJavaScriptTransformer::__construct($viewBinder, $namespace);
	 }
	 ...
	 */
	 public static function put($vars){
		 Laracasts\Utilities\JavaScript\PHPToJavaScriptTransformer::put($vars);
	 }
