...
class MessagesController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('users.messages.index');
    }
    ...
    {
        return $this->view('users.messages.outbox');
    }

    public function trash()
    {
        return $this->view('users.messages.trash');
    }
    ...
    public function viewMessage($message_id)
    {
        ...
        $this->setData('users', $this->users->allVitals());
        return $this->view('users.messages.view');
    }

    public function create()
    {
        return $this->view('users.messages.create');
    }
