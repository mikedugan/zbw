...
class ExamsController extends BaseController
{
    ...
    public function getIndex()
    {
        ...
        return $this->view('training.exams.all');
    }
    ...
    public function getStaffReview($eid)
    {
        ...
        return $this->view('staff.exams.review');
    }
    ...
    public function getReview()
    {
        ...
        return $this->view('training.exams.review');
    }

    public function getIntro($eid)
    {
        return $this->view('training.exams.intro');
    }

    public function getTake($eid)
    {
        $this->setData('exam', $this->exams->get($eid));
        return $this->view('training.exams.take');
    }
    ...
    public function getQuestions()
    {
        ...
        return $this->view('staff.exams.view-questions');
    }
    ...
    public function getEditQuestion($id)
    {
        ...
        return $this->view('staff.exams.edit');
    }
