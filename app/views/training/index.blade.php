...
@section('content')
    <div class="col-md-12">
        ...
        <h5>Current ZBW Certification: <span class="sans">{{ \Zbw\Helpers::readableCert($me->cert) }}</span></h5>
    </div>
    <div class="col-md-6">
        @if($me->cert < 10)
        <a class="btn btn-primary" href="/e/request{{ $me->cid}}/{{ $me->cert + 1 }}">Request {{ \Zbw\Helpers::readableCert($me->cert + 1) }} Exam</a>
