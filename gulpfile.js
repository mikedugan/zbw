...
var files = {
    js: ['public/js/froala_editor.min.js','public/js/bootstrap.js','public/js/datetimepicker.js','public/js/bootstrapValidator.min.js','public/js/fileinput.js','public/js/functions.js','public/js/events.js','public/js/custom.js'],
    images: paths.images + '**/*',
