...
<div>
    ...
    <p><b>Rating: </b> {{ $staff->rating->long }} / {{ Zbw\Core\Helpers::readableCert($staff->cert) }}</p>
    ...
    <hr/>
    <div>{{ $content }}</div>
    <p><b>Do not reply to this email.</b> You may respond {{ \HTML::linkRoute('messages', 'here') }} after logging in.</p>
</div>
