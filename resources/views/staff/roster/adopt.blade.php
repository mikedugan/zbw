<div class="panel-group" id="adoption">
                    ...
                    @foreach($students as $student)
                        <tr>
                            ...
                            @if(! $student->adopted_by)
                                <td><a class="btn btn-success btn-sm" href="/staff/adopt/{{$student->cid}}">Adopt</a>
                                </td>
                            @elseif($student->adopted_by === $me->cid)
                                <td><a class="btn btn-danger btn-sm" href="/staff/adopt/{{$student->cid}}/drop">Drop</a>
                                </td>
                            @endif
                        </tr>
                    @endforeach
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="adoption" href="#collapseMine">My Adoptions</a>
            </h4>
        </div>
        <div id="collapseMine" class="panel-collapse collapse">
            <div class="panel-body">
                <table class="table table-bordered">
                    <thead>
                    <tr>
