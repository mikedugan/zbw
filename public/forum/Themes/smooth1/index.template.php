...
function template_html_above()
{
    ...
    echo '
	<link rel="stylesheet" href="../../../dist/zbw.min.css">
    ...
    echo '
    <link rel="stylesheet" href="'.$settings['theme_url'].'/css/styles.css'.'">';
...
<nav class="navbar-default navbar">
                <a class="hidden-sm hidden-xs" id="logo" href="http://localhost:8000"><img src="http://localhost:8000/dist/images/zbw_logo.png" alt="vZBW ARTCC"></a>
</nav>';
    template_menu();
}
...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '
    ...
    if ($context['user']['is_logged']) {
        if (!empty($context['user']['avatar'])) {
            echo '
				<p style="display:none;" class="avatar">', $context['user']['avatar']['image'], '</p>';
        }
       /* echo '
          <p>
					<span class="greeting">', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></span> |
					<span><a href="', $scripturl, '?action=unread">', 'Unread Posts', '</a></span> |
					<span><a href="', $scripturl, '?action=unreadreplies">', 'Unread Replies', '</a></span></p>';*/
...
function template_body_below()
{
	...
	<div id="footer_section"><div>
		<ul class="reset">
			<li class="copyright">&copy;2014 <a href="http://mjdugan.com">Mike Dugan</a> / <a href="http://bostonartcc.net">vZBW</a></li>';
...
function template_menu()
{
    ...
    echo '
		<div id="main_menu" class="navbar-nav nav">
			<ul class="dropmenu">';
    ...
    echo '
			...
			<p class="pull-right userinfo">
					<span class="greeting">', 'Hello, ', ' <span>', $context['user']['name'], '</span></span>
					<!--<span><a href="', $scripturl, '?action=unread">', 'Unread Posts', '</a></span> |
					<span><a href="', $scripturl, '?action=unreadreplies">', 'Unread Replies', '</a></span></p>-->
		</div>';
}
...
function dt()
{
    ...
    if (!empty($settings['advert_control'])) {
		...
		<div id="upshrinkHeaderIC1">	
			...
			<span id="advert">', !empty($settings['advertt']) ? '' . parse_bbc($settings['advertt']) . '' : '', '</span>';
        echo '
		</div>';
    }
}
